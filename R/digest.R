#' In silico trypsin digestion of a protein
#' @param x a character of peptide/protein sequence
#' @param maxMissed max miss cleavages allow
#' @param minLen the minumum length
#' @param maxLen the maximum length
#' @param annot user defined annotation for the protein
#' @param cleaveProline logical; whether proline should be cleaved
...
#' In silico trypsin digestion of proteins in a list
#' @param x a list of proteins
#' @param ... other arguments passed to trypsinDigest 
